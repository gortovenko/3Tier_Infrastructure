  ...
  user_data                                         = <<-EOF
                                                        ...
                                                        <html lang="en">
                                                            <head>
                                                                ...
                                                                <title>Hello this is my private Project : github: @gortovenko </title>
                                                            ...
                                                            <body>
                                                                <div class="wrapper">
                                                                    <div class="container">
                                                                        <h1>Welcome! Your IaC launched success. Congratulation.</h1>
                                                                        <h2>Pavlo H, please follow my github: @gortovenko</h2>
                                                                    </div>
                                                                </div>
                                                            </body>
                                                        </html>
